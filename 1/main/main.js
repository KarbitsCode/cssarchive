...
function AddGlyphs(Path) {
    cmn.RegWbFnt('MG_Icons', 'MG_Icons', Path + 'MG_Icons', 'r52754604', true);
};
...
function mnF3216978LCn(Path) {
    ...
    this.SelIts = null;
    this.SMH = '10000';
    this.nids = '<ii9><ii1/><ii2/><ii3/><ii4/><ii5/><ii6/><ii7/><ii8/></ii9>';
    this.SbmAtHd = true;
    this.PosVertTyp = '1';
};
...
var main = {
    ...
    Prepare: function () {
        ...
        main.Mnu = '<div><input id="sit_mnF3216978_vs" name="sit_mnF3216978_vs" type="hidden" value="" /></div><div id="mnF3216978_-0p" class="FBFEMainMenuDIV" onmouseover="dm.vD();" onmouseout="dm.uD();" style="visibility:hidden;z-index:999999;position:static;vertical-align:top;display:-moz-inline-stack;display:inline-block;zoom:1;*display:inline;"><table border="0" cellspacing="0" cellpadding="0" onclick="dm.mc();"><tr><td onmouseout="dm.u(this);" id="mnF3216978_i9" onclick="dm.ItClk(this,\'\',\'1\');" class="FBFEMainMenuItemTD" onmouseover="dm.v(this, 1);"><table border="0" cellspacing="0" cellpadding="0"><tr><td class="FBFEIconTD"><font class="MG_Icons">&#xe720;</font></td><td class="FBFETitleTD" id="mnF3216978_i9-tl">Main</td><td class="FBFEArrowTD"><font class="MG_Icons" style="font-size:16px;width:10px;padding-left:10px;">&#xea20;</font></td></tr></table></td></tr></table></div>';
        ...
        main.SubMnu = '<div id="<r>ifc"></div><div id="<r>_i9' + s0 + '9' + s2 + '1<n>\'\',\'1\<z>../redir.html?go=1/ascii.html\',\'_self\');<l>2);<c>><tr><td<t>IconTD">&nbsp;<j>TitleTD<k>_i1-tl">ASCII Art' + s3 + '2<n>\'\',\'1\<z>../redir.html?go=1/css.html\',\'_self\');<l>2);<c>><tr><td<t>IconTD">&nbsp;<j>TitleTD<k>_i2-tl">Contoh CSS' + s3 + '3<n>\'\',\'1\<z>../redir.html?go=1/gmbr.html\',\'_self\');<l>2);<c>><tr><td<t>IconTD">&nbsp;<j>TitleTD<k>_i3-tl">Gambar Bergerak' + s3 + '4<n>\'\',\'1\<z>../redir.html?go=1/psd.html\',\'_self\');<l>2);<c>><tr><td<t>IconTD">&nbsp;<j>TitleTD<k>_i4-tl">Photoshop Web' + s3 + '5<n>\'\',\'1\<z>../redir.html?go=1/temp.html\',\'_self\');<l>2);<c>><tr><td<t>IconTD">&nbsp;<j>TitleTD<k>_i5-tl">Konversi Suhu' + s3 + '6<n>\'\',\'1\<z>../redir.html?go=1/calc.html\',\'_self\');<l>2);<c>><tr><td<t>IconTD">&nbsp;<j>TitleTD<k>_i6-tl">Kalkulator' + s3 + '7<n>\'\',\'1\<z>../redir.html?go=1/py.html\',\'_self\');<l>2);<c>><tr><td<t>IconTD">&nbsp;<j>TitleTD<k>_i7-tl">PyScript' + s3 + '8<n>\'\',\'1\<z>../redir.html?go=1/warna.html\',\'_self\');<l>2);<c>><tr><td<t>IconTD">&nbsp;<j>TitleTD<k>_i8-tl">Warna<j>ArrowTD<f></table></div></div>';
