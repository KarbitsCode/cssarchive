/*!
 * JavaScript code for dropdown menu (created: April 10, 2025 06:08:50, Hash: 113D, UID_CRC: EDAFB52B)
...
function AddGlyphs(Path) {
    cmn.RegWbFnt('MG_Icons', 'MG_Icons', Path + 'MG_Icons', 'r94430684', true);
};
...
function mnF3216978LCn(Path) {
    ...
    this.SelIts = null;
    this.SMH = '10000';
    this.nids = '<ii3><ii4/><ii5/><ii6/><ii7/><ii8/><ii13/><ii9/><ii10/><ii11/><ii12/></ii3>';
    this.SbmAtHd = true;
    this.PosVertTyp = '1';
    this.ttt_mnF3216978_i3 = 'main';
    this.ttt_mnF3216978_i4 = 'ascii';
    this.ttt_mnF3216978_i5 = 'css';
    this.ttt_mnF3216978_i6 = 'dcd';
    this.ttt_mnF3216978_i7 = 'rvu';
    this.ttt_mnF3216978_i8 = 'unipad';
    this.ttt_mnF3216978_i13 = 'unity';
    this.ttt_mnF3216978_i9 = 'flash';
    this.ttt_mnF3216978_i10 = 'calc';
    this.ttt_mnF3216978_i11 = 'py';
    this.ttt_mnF3216978_i12 = 'cnt';
};
...
var main = {
    ...
    Prepare: function () {
        ...
        main.SubMnu = '<div id="<r>ifc"></div><div id="<r>_i3' + s0 + '3' + s2 + '4<n>\'\',\'1\<z>' + getRoot() + 'redir.html?go=1/ascii.html\',\'_self\');<l>2<y>>&#xe74e;<h>4-tl">ASCII Art' + s3 + '5<n>\'\',\'1\<z>' + getRoot() + 'redir.html?go=1/css.html\',\'_self\');<l>2<y>>&#xe74e;<h>5-tl">CSS Projects' + s3 + '6<n>\'\',\'1\<z>' + getRoot() + 'redir.html?go=1/dcd.html\',\'_self\');<l>2<y>>&#xe74e;<h>6-tl">Dicoding Projects' + s3 + '7<n>\'\',\'1\<z>' + getRoot() + 'redir.html?go=1/rvu.html\',\'_self\');<l>2<y>>&#xe74e;<h>7-tl">RevoU Projects' + s3 + '8<n>\'\',\'1\<z>' + getRoot() + 'redir.html?go=1/unipad.html\',\'_self\');<l>2<y>>&#xe74e;<h>8-tl">Unipad Player' + s3 + '13<n>\'\',\'1\<z>' + getRoot() + 'redir.html?go=1/unity.html\',\'_self\');<l>2<y>>&#xe74e;<h>13-tl">Unity Games' + s3 + '9<n>\'\',\'1\<z>' + getRoot() + 'redir.html?go=1/flash.html\',\'_self\');<l>2<y>>&#xe74e;<h>9-tl">Flash Games' + s3 + '10<n>\'\',\'1\<z>' + getRoot() + 'redir.html?go=1/calc.html\',\'_self\');<l>2<y>>&#xe74e;<h>10-tl">Calculator' + s3 + '11<n>\'\',\'1\<z>' + getRoot() + 'redir.html?go=1/py.html\',\'_self\');<l>2<y>>&#xe74e;<h>11-tl">PyScript' + s3 + '12<n>\'\',\'1\<z>' + getRoot() + 'redir.html?go=1/cnt.html\',\'_self\');<l>2<y>>&#xe74e;<h>12-tl">Counter<j>ArrowTD<f></table></div></div>';
