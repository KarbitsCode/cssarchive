/*!
 * JavaScript code for dropdown menu (created: February 02, 2025 07:53:05, Hash: CE4C, UID_CRC: EF967046)
...
function AddGlyphs(Path) {
    cmn.RegWbFnt('MG_Icons', 'MG_Icons', Path + 'MG_Icons', 'r179151910', true);
};
