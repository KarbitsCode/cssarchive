/*!
 * JavaScript code for dropdown menu (created: January 01, 2024 06:03:24, Hash: C406, UID_CRC: 17851FBA)
...
function cmnc() {
  ...
  this.ItmPrc = function (prc, uid, id, ttl) {
    try {
      ...
      if (wen == "true") {
        alert(
          "Error! Check the client-side code: " +
            prc +
            "\r\n\r\nDescription: " +
            e.description +
            ".",
  ...
  this.AjaxRzErr = function (Tx, cntx) {
    try {
      ...
      if (wen == "true") {
        var msg =
          "Error! APNSoft Control cannot get data from the server! \r\nException Details: " +
          Tx;
        alert(msg);
      }
    } catch (ex) {
  ...
  this.ShwShd = function (Obj, PngShdCnt, ccp) {
    ...
    cmn.setLeft(
      ShCrn,
      x + Obj.offsetWidth + ShRgt.offsetWidth - ShCrn.offsetWidth,
    );
    ...
    if (PngShdCnt == 2) {
      cmn.setLeft(ShBtm, x);
      ShBtm.style.width =
        Obj.offsetWidth + ShRgt.offsetWidth - ShCrn.offsetWidth + "px";
    }
    if (PngShdCnt == 3) {
  ...
  this.cmb = function () {
    ...
    if (
      document.compatMode &&
      document.compatMode.toLowerCase().indexOf("back") < 0
    ) {
      r = true;
    }
    return r;
  ...
  this.dBv = function (nm) {
    ...
    var saf =
      ua.indexOf("safari") != -1 && ua.indexOf("mac") != -1 ? true : false;
    var SafWin =
      !saf && ua.indexOf("safari") != -1 && ua.indexOf("windows") != -1
        ? true
        : false;
  ...
  this.RegWbFnt = function (Fid, Fml, Path, Rnd, Frmt) {
    ...
    if (Frmt) {
      Css =
        ...
        "\"] {font-family: '" +
        Fml +
        "' !important;font-style: normal;font-weight: normal;font-variant: normal;text-transform: none;line-height: 1;-webkit-font-smoothing: antialiased;-moz-osx-font-smoothing: grayscale;}";
    }
  ...
  this.DeCompact = function (s, c, m, g, r) {
    ...
    s = s.replace(
      /<w>/gi,
      'SubMenuDIV" onclick="dm.mc();" onmouseover="dm.vD();" onmouseout="dm.uD();"><div style="display:-moz-inline-stack;display:inline-block;margin:0;vertical-align:top;position:absolute;',
    );
    ...
    s = s.replace(
      /<l>/gi,
      '" class="' + c + 'SubMenuItemTD" onmouseover="dm.v(this, ',
    );
  ...
  this.RspMnAct = function (uid, DvMb, SbDv, dv) {
    try {
      ...
      if (RgEdg - SBr > wW) {
        ...
        if (DvMb.Fxd) {
          DvMb.style.width =
            wW - cmn.pX(DvMb) - DvPdd * 2 - _ScrVals.scL + "px";
        } else {
...
function AddGlyphs(Path) {
  cmn.RegWbFnt("MG_Icons", "MG_Icons", Path + "MG_Icons", "r410283862", true);
}

function AddCss_main(Path, HostURL) {
  var Css =
    ".AC98MainMenuDIV *, .AC98SubMenuDIV * {-webkit-box-sizing: content-box !important;-moz-box-sizing: content-box !important;box-sizing: content-box !important;}.AC98MainMenuDIV TD, .AC98SubMenuDIV TD {vertical-align: middle;border: none;padding: 0px;}.AC98Defaults {color: #51729A;OverlapVertical: -3px;OverlapHorizontal: 7px;}.AC98IconTD, .AC98TitleTD, .AC98ArrowTD, .AC98HeaderTD, .AC98TitleTD * {text-shadow: none;font-size: 16px;font-family: Trebuchet MS;white-space: nowrap;padding: 0px;line-height: normal;vertical-align: middle;}.AC98TitleTD {text-align: left;}.AC98ArrowTD {padding-left: 2px;}.AC98IconTD font, .AC98ArrowTD font {margin: 0 !important;display: block !important;padding: 0px;line-height: 16px;}.AC98MainMenuDIV {border: solid 1px !important;border-color: #D8D8D8 !important;padding: 4px;background-color: #EAEAEA;background: -moz-linear-gradient(top, #F8F8F8 0%, #E3E3E3 100%); background: -webkit-linear-gradient(top, #F8F8F8 0%, #E3E3E3 100%); background: linear-gradient(to bottom, #F8F8F8 0%, #E3E3E3 100%); filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#F8F8F8', endColorstr='#E3E3E3', GradientType=0);;cursor: default;}.AC98MainMenuDIV .AC98HeaderTD {text-align: left;padding: 6px !important;padding-left: 6px !important;padding-right: 6px !important;color: #959595;}.AC98MainMenuDIV TABLE {width: auto;border: none;border-collapse: separate;margin: 0px;padding: 0px;}.AC98MainMenuDIV{display:-moz-inline-stack;display:inline-block;zoom:1;*display:inline;overflow:hidden;-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;}.AC98MainMenuItemTD {padding: 9px !important;padding-left: 6px !important;padding-right: 6px !important;}.AC98MainMenuItemTD .AC98TitleTD, .AC98MainMenuItemTD .AC98IconTD, .AC98MainMenuItemTD .AC98ArrowTD {color: #3A536E;text-shadow: 1px 1px 1px #FFFFFF;}.AC98MainMenuItemHoveredTD {padding: 9px !important;padding-left: 6px !important;padding-right: 6px !important;background-color: #51729A;cursor: default;cursor: hand;cursor: pointer;}.AC98MainMenuItemHoveredTD .AC98TitleTD, .AC98MainMenuItemHoveredTD .AC98IconTD, .AC98MainMenuItemHoveredTD .AC98ArrowTD {color: #FFFFFF;text-shadow: 1px 1px 1px #3B5471;}.AC98MainMenuItemSelectedTD {padding: 9px !important;padding-left: 6px !important;padding-right: 6px !important;background-color: #D9D9D9;}.AC98MainMenuItemSelectedTD .AC98TitleTD, .AC98MainMenuItemSelectedTD .AC98IconTD, .AC98MainMenuItemSelectedTD .AC98ArrowTD {color: #3A536E;}.AC98SubMenuDIV {-moz-box-sizing: content-box;-webkit-box-sizing: content-box;box-sizing: content-box;padding: 6px;background-color: #51729A;cursor: default;}.AC98SubMenuDIV .AC98HeaderTD {text-align: left;padding: 5px !important;padding-left: 6px !important;padding-right: 6px !important;color: #91A8C4;}.AC98SubMenuDIV TABLE {border: none;border-collapse: separate;width: auto !important;margin: 0px;padding: 0px;}.AC98SubMenuItemTD, .AC98SubResDIV {padding: 6px !important;padding-left: 7px !important;padding-right: 7px !important;}.AC98SubMenuItemTD .AC98TitleTD, .AC98SubMenuItemTD .AC98IconTD, .AC98SubMenuItemTD .AC98ArrowTD, .AC98SubResDIV {color: #FFFFFF;text-shadow: 1px 1px 1px #3B5471;}.AC98SubMenuItemHoveredTD, .AC98SubResDIV:hover {padding: 6px !important;padding-left: 7px !important;padding-right: 7px !important;background-color: #EBEBEB;cursor: default;cursor: hand;cursor: pointer;}.AC98SubMenuItemHoveredTD .AC98TitleTD, .AC98SubMenuItemHoveredTD .AC98IconTD, .AC98SubMenuItemHoveredTD .AC98ArrowTD, .AC98SubResDIV:hover {color: #3A536E;text-shadow: 1px 1px 1px #FFFFFF;}.AC98SubMenuItemSelectedTD {padding: 6px !important;padding-left: 7px !important;padding-right: 7px !important;background-color: #7190B4;}.AC98SubMenuItemSelectedTD .AC98TitleTD, .AC98SubMenuItemSelectedTD .AC98IconTD, .AC98SubMenuItemSelectedTD .AC98ArrowTD {color: #FFFFFF;text-shadow: 1px 1px 1px #3B5471;}.AC98SeparatorVerticalTD {padding: 0px !important;border-left-style: solid !important;border-left-width: 1px !important;border-left-color: #9A9A9A !important;background-color: #DEDEDE;}.AC98SeparatorVerticalTD TABLE {width: 1px;}.AC98SeparatorHorizontalTD {padding: 0px !important;background-color: #698AB0 !important;border-top-style: solid !important;border-top-width: 1px !important;border-top-color: #3E5876 !important;}.AC98MainMenuDIV .AC98SeparatorHorizontalTD {padding: 0px !important;border-top-style: solid !important;border-top-width: 1px !important;border-top-color: #DEDEDE !important;background-color: #FFFFFF !important;}.AC98MltClmnSepar1TD {padding-left: 4px !important;}.AC98MltClmnSepar1AddTD {border-left-style: solid !important;border-left-width: 1px !important;border-left-color: #698AB0 !important;}.AC98MltClmnSepar2TD {padding-right: 4px !important;border-right-style: solid !important;border-right-width: 1px !important;border-right-color: #3E5876 !important;}.AC98SepVertHorSubmTD {border-left-color: #3E5876 !important;background-color: #698AB0;}.AC98TooltipDIV {font-family: Trebuchet MS;font-size: 12px;color: #555555;padding: 3px;padding-left: 5px;padding-right: 5px;background-color: #F8F8F8;border: solid 1px #888888;}.AC98SubMenuDIV, .AC98TooltipDIV {-webkit-box-shadow: 3px 3px 7px 0px rgba(50, 50, 50, 0.20); -moz-box-shadow: 3px 3px 7px 0px rgba(50, 50, 50, 0.20); box-shadow: 3px 3px 7px 0px rgba(50, 50, 50, 0.20);}.AC98MainMenuDIV, .AC98SubMenuDIV {border-radius: 4px; -webkit-border-radius:4px; -khtml-border-radius:4px; -moz-border-radius:4px;}.AC98MainMenuItemHoveredTD, .AC98MainMenuItemSelectedTD, .AC98SubMenuItemHoveredTD, .AC98SubResDIV:hover, .AC98SubMenuItemSelectedTD, .AC98TooltipDIV {border-radius: 3px; -webkit-border-radius:3px; -khtml-border-radius:3px; -moz-border-radius:3px;}.AC98IconTD {color: #000000;vertical-align: middle;text-align: center;}.AC98IconTD font {font-size: 16px;padding-left: 2px;padding-right: 8px;width: 16px;}.AC98ArrowNotitleTD font {padding-left: 0px !important;}";

  cmn.RegPageCss("Style_Menu_AC98", Css, true);
}
...
function mnF3216978LCn(Path) {
  ...
  this.SelIts = null;
  this.SMH = "10000";
  this.nids = "<ii3><ii4/><ii5/><ii6/><ii7/><ii8/><ii9/></ii3>";
  this.SbmAtHd = true;
  this.PosVertTyp = "1";
}
...
var main = {
  ...
  Prepare: function () {
    ...
    main.Mnu =
      '<div><input id="sit_mnF3216978_vs" name="sit_mnF3216978_vs" type="hidden" value="" /></div><div id="mnF3216978_-0p" class="AC98MainMenuDIV" onmouseover="dm.vD();" onmouseout="dm.uD();" style="visibility:hidden;z-index:999999;position:static;vertical-align:top;display:-moz-inline-stack;display:inline-block;zoom:1;*display:inline;"><table border="0" cellspacing="0" cellpadding="0" onclick="dm.mc();"><tr><td onmouseout="dm.u(this);" id="mnF3216978_i3" onclick="dm.ItClk(this,\'\',\'1\');" class="AC98MainMenuItemTD" onmouseover="dm.v(this, 1);"><table border="0" cellspacing="0" cellpadding="0"><tr><td class="AC98IconTD"><font class="MG_Icons">&#xe720;</font></td><td class="AC98TitleTD" id="mnF3216978_i3-tl">Main</td><td class="AC98ArrowTD"><font class="MG_Icons" style="font-size:16px;width:10px;padding-left:10px;">&#xea20;</font></td></tr></table></td></tr></table></div>';
    var s0 =
      '-p" style="Z-INDEX:999999;height:auto;visibility:hidden;POSITION:absolute;LEFT:1px;TOP:1px;WIDTH:auto;padding:0px;"><div<t>SubMenuDIV" onclick="dm.mc();" onmouseover="dm.vD();" onmouseout="dm.uD();<c> id="<r>_i';
    var s2 = '-smt"><g><r>_i';
    var s3 = "<j>ArrowTD<f><g><r>_i";
    var s9 = "<n>'','1<z>./";
    main.SubMnu =
      '<div id="<r>ifc"></div><div id="<r>_i3' +
      s0 +
      "3" +
      s2 +
      "4" +
      s9 +
      "../redir.html?go=1/ascii.html','');<l>2<y>>&#xe74e;<h>4-tl\">ASCII Art" +
      s3 +
      "5" +
      s9 +
      "../redir.html?go=1/css.html','');<l>2<y>>&#xe74e;<h>5-tl\">Contoh CSS" +
      s3 +
      "6" +
      s9 +
      "../redir.html?go=1/gmbr.html','');<l>2<y>>&#xe74e;<h>6-tl\">Gambar Bergerak" +
      s3 +
      "7" +
      s9 +
      "../redir.html?go=1/psd.html','');<l>2<y>>&#xe74e;<h>7-tl\">Photoshop Web" +
      s3 +
      "8" +
      s9 +
      "../redir.html?go=1/py.html','');<l>2<y>>&#xe74e;<h>8-tl\">PyScript" +
      s3 +
      "9" +
      s9 +
      "../redir.html?go=1/warna.html','');<l>2<y>>&#xe74e;<h>9-tl\">Warna<j>ArrowTD<f></table></div></div>";
    main.SubMnu = cmn.DeCompact(
      main.SubMnu,
      "AC98",
      "mnF3216978",
      "MG_Icons",
