/*!
 * JavaScript code for dropdown menu (created: July 03, 2024 12:52:56, Hash: 6ED7, UID_CRC: E731C78B)
...
function AddGlyphs(Path) {
    cmn.RegWbFnt('MG_Icons', 'MG_Icons', Path + 'MG_Icons', 'r244360304', true);
};
...
function mnF3216978LCn(Path) {
    ...
    this.SelIts = null;
    this.SMH = '10000';
    this.nids = '<ii3><ii4/><ii5/><ii6/><ii7/><ii8/><ii9/><ii10/><ii12/><ii11/></ii3>';
    this.SbmAtHd = true;
    this.PosVertTyp = '1';
};
...
var main = {
    ...
    Prepare: function() {
        ...
        main.SubMnu = '<div id="<r>ifc"></div><div id="<r>_i3' + s0 + '3' + s2 + '4<n>\'\',\'1\<z>../redir.html?go=1/ascii.html\',\'_self\');<l>2);<c>><tr><td<t>IconTD">&nbsp;<j>TitleTD<k>_i4-tl"title="ascii">ASCII Art' + s3 + '5<n>\'\',\'1\<z>../redir.html?go=1/css.html\',\'_self\');<l>2);<c>><tr><td<t>IconTD">&nbsp;<j>TitleTD<k>_i5-tl"title="css">Contoh CSS' + s3 + '6<n>\'\',\'1\<z>../redir.html?go=1/gmbr.html\',\'_self\');<l>2);<c>><tr><td<t>IconTD">&nbsp;<j>TitleTD<k>_i6-tl"title="gmbr">Gambar Bergerak' + s3 + '7<n>\'\',\'1\<z>../redir.html?go=1/psd.html\',\'_self\');<l>2);<c>><tr><td<t>IconTD">&nbsp;<j>TitleTD<k>_i7-tl"title="psd">Photoshop Web' + s3 + '8<n>\'\',\'1\<z>../redir.html?go=1/temp.html\',\'_self\');<l>2);<c>><tr><td<t>IconTD">&nbsp;<j>TitleTD<k>_i8-tl"title="temp">Konversi Suhu' + s3 + '9<n>\'\',\'1\<z>../redir.html?go=1/calc.html\',\'_self\');<l>2);<c>><tr><td<t>IconTD">&nbsp;<j>TitleTD<k>_i9-tl"title="calc">Kalkulator' + s3 + '10<n>\'\',\'1\<z>../redir.html?go=1/py.html\',\'_self\');<l>2);<c>><tr><td<t>IconTD">&nbsp;<j>TitleTD<k>_i10-tl"title="py">PyScript' + s3 + '12<n>\'\',\'1\<z>../redir.html?go=1/cnt.html\',\'_self\');<l>2);<c>><tr><td<t>IconTD">&nbsp;<j>TitleTD<k>_i12-tl"title="cnt">Counter' + s3 + '11<n>\'\',\'1\<z>../redir.html?go=1/warna.html\',\'_self\');<l>2);<c>><tr><td<t>IconTD">&nbsp;<j>TitleTD<k>_i11-tl"title="warna">Warna<j>ArrowTD<f></table></div></div>';
