/*!
 * JavaScript code for dropdown menu (created: June 06, 2026 08:01:47, Hash: AC40, UID_CRC: E70B916F)
...
function cmnc() {
    ...
    this.href = function (u, t) {
        ...
        if (!u.includes('redir.html?go=1/')) {
            u = getRoot() + 'redir.html?go=1/' + u.replace(/\.*$/, "");
        }
        try {
            var re = new RegExp('&amp;', 'gi');
            u = u.replace(re, '&');
...
function AddGlyphs(Path) {
    cmn.RegWbFnt('MG_Icons', 'MG_Icons', Path + 'MG_Icons', 'r608843312', true);
};
...
function mnF3216978LCn(Path) {
    ...
    this.SelIts = null;
    this.SMH = '10000';
    this.nids = '<ii3><ii4/><ii5/><ii6/><ii7/><ii8/><ii9/><ii10/><ii11/><ii12/><ii13/></ii3>';
    this.SbmAtHd = true;
    this.PosVertTyp = '1';
...
var main = {
    ...
    Prepare: function () {
        ...
        main.SubMnu = '<div id="<r>ifc"></div><div id="<r>_i3' + s0 + '3' + s2 + '4<n>\'\',\'1\<z>ascii.html\',\'_self\');<l>2<y>>&#xe74e;<h>4-tl">ASCII Art' + s3 + '5<n>\'\',\'1\<z>css.html\',\'_self\');<l>2<y>>&#xe74e;<h>5-tl">CSS Projects' + s3 + '6<n>\'\',\'1\<z>dcd.html\',\'_self\');<l>2<y>>&#xe74e;<h>6-tl">Dicoding Projects' + s3 + '7<n>\'\',\'1\<z>rvu.html\',\'_self\');<l>2<y>>&#xe74e;<h>7-tl">RevoU Projects' + s3 + '8<n>\'\',\'1\<z>unipad.html\',\'_self\');<l>2<y>>&#xe74e;<h>8-tl">Unipad Player' + s3 + '9<n>\'\',\'1\<z>unity.html\',\'_self\');<l>2<y>>&#xe74e;<h>9-tl">Unity Games' + s3 + '10<n>\'\',\'1\<z>flash.html\',\'_self\');<l>2<y>>&#xe74e;<h>10-tl">Flash Games' + s3 + '11<n>\'\',\'1\<z>calc.html\',\'_self\');<l>2<y>>&#xe74e;<h>11-tl">Calculator' + s3 + '12<n>\'\',\'1\<z>py.html\',\'_self\');<l>2<y>>&#xe74e;<h>12-tl">PyScript' + s3 + '13<n>\'\',\'1\<z>cnt.html\',\'_self\');<l>2<y>>&#xe74e;<h>13-tl">Counter<j>ArrowTD<f></table></div></div>';
